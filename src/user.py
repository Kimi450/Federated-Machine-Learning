...
class User:
    ...
    def get_data(self, ignore_first_n = 0, loss = False, accuracy = False, pre = False, post = False):
    ...
    def add_pre_fit_evaluation(self, pre_fit_evaluation):
        self._pre_fit_loss = np.append(self.get_pre_fit_loss(), pre_fit_evaluation[0])
        self._pre_fit_accuracy = np.append(self.get_pre_fit_accuracy(), pre_fit_evaluation[1])

    def add_post_fit_evaluation(self,post_fit_evaluation):
        self._post_fit_loss = np.append(self.get_post_fit_loss(), post_fit_evaluation[0])
        self._post_fit_accuracy = np.append(self.get_post_fit_accuracy(), post_fit_evaluation[1])
